...
const proxyListURL = atob("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0Zvb2xWUE4tSUQvTmF1dGljYS9yZWZzL2hlYWRzL21haW4vcHJveHlMaXN0LnR4dA==");
      ...
      */
      ...
      if (upgradeHeader === "websocket") {
        ...
        */
        ...
        if (ipPortMatch) {
          proxyIP = ipPortMatch[1]; // Standarisasi menjadi ip:port
        ...
        <div class="card">
            ...
            <form id="subLinkForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="bug" placeholder="0.0.0.0"> 
                </div>
    ...
    .pipeTo(
      new WritableStream({
        async write(chunk, controller) {
          if (isDNS) {
            return handleUDPOutbound(DOH_ADDR, DOH_PORT, chunk, webSocket, null, log);
          }
          ...
          if (isDNS) {
            return handleUDPOutbound(DOH_ADDR, DOH_PORT, chunk, webSocket, protocolHeader.version, log);
          }
...
async function handleUDPOutbound(targetAddress, targetPort, udpChunk, webSocket, responseHeader, log /*webSocket, responseHeader, log*/ ) {
  /*
